...
1. Participants sit at a comfortable viewing distance from the computer screen
2. On each trial:
...
3. Each participant completes a fixed number of trials with comparison sizes randomly sampled from the available range
4. Sessions last approximately 15 minutes
